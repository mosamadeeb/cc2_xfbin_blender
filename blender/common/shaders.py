...
def _01_F002(self, xfbin_mat, matname, nodegrp = '01F002'):
...
def _01_F008(self, xfbin_mat, matname, nodegrp = '01F008'):
...
def _07_F00D(self, xfbin_mat, matname, nodegrp = '07F00D'):
	...
	if xfbin_mat.texture_groups and xfbin_mat.texture_groups[0].textures:
		...
		image_name2 = xfbin_mat.texture_groups[0].textures[1].texture
		tex2.image = bpy.data.images.get(image_name2)
		image_name3 = xfbin_mat.texture_groups[0].textures[2].texture
...
def _07_F010(self, xfbin_mat, matname, nodegrp = '07F020'):
	...
	if xfbin_mat.texture_groups and xfbin_mat.texture_groups[0].textures:
		...
		image_name2 = xfbin_mat.texture_groups[0].textures[1].texture
		tex2.image = bpy.data.images.get(image_name2)
		image_name3 = xfbin_mat.texture_groups[0].textures[3].texture
		tex3.image = bpy.data.images.get(image_name3)
		image_name4 = xfbin_mat.texture_groups[0].textures[2].texture
